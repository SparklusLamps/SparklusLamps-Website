...
export const heroContent = {
  ...
  heading: "Luxury Lighting Redefined",
  description:
    "Discover the perfect blend of elegance and innovation with Sparklus Lamps. Each piece is crafted to transform spaces into timeless masterpieces.",
...
export const faqs = [
  ...
  {
    id: 2,
    question: "Do you offer customized lamp designs?",
    answer:
      "Yes. In addition to our signature collection, we create customized lamps tailored to your space, theme, and lighting requirements. Whether you're an interior designer with a specific vision or a homeowner looking for something personal, we can design and craft it exclusively for you.",
  },
  {
    id: 3,
